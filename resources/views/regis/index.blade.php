                ...
                <div class="p-4 sm:p-8 md:p-12 max-w-5xl mx-auto text-sm sm:text-base md:text-lg">
                    ...
                    <div class="mt-8 flex justify-center">
                        <a href="{{ route('download.pdf', ['kode' => $kode, 'tanggal' => $besok]) }}" 
                            class="bg-blue text-white px-4 sm:px-6 py-2 sm:py-3 rounded-xl hover:bg-blue-600 transition duration-300 ease-in-out inline-block animate-pulse-light text-sm sm:text-base">
                            <span class="flex items-center">
                                <svg class="w-4 h-4 sm:w-5 sm:h-5 mr-2 animate-bounce" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path>
                                </svg>
                                Download Bukti <span class="hidden sm:inline">&nbsp;Pendaftaran</span>
                            </span>
                        </a>
                    </div>
                </div>
...
document.addEventListener("alpine:init", () => {
    ...
    document.addEventListener("DOMContentLoaded", function () {
            ...
            if (nomor_rm.value && tanggal_lahir.value) {
                ...
                .then((data) => {
                    if (data.exists) {
                        ...
                        document.getElementById("nama_pasien_baru").setAttribute("readonly", true);
                        document.getElementById("tempat_lahir_baru").setAttribute("readonly", true);
                        document.getElementById("tanggal_lahir_baru").setAttribute("readonly", true);
                        document.getElementById("alamat_baru").setAttribute("readonly", true);
                        document.getElementById("nomor_telepon_baru").setAttribute("readonly", true);
                        document.getElementById("email_baru").setAttribute("readonly", true);
                        document.getElementById("nomor_kartu_baru").setAttribute("readonly", true);
                        } else {
                        document.getElementById("berikutnya").classList.add("hidden");
                        document.getElementById("berikutnyaFalse").classList.remove("hidden");
        ...
        function openAll() {
            ...
            document.querySelector('input[name="jenis_kelamin"][value="Perempuan"]').checked = false;
            document.querySelector('input[name="jenis_kelamin"][value="Laki-laki"]').disabled = false;
            document.querySelector('input[name="jenis_kelamin"][value="Laki-laki"]').checked = false;
            document.querySelector('input[name="jenis_kelamin"][value="Perempuan"]').disabled = false;
